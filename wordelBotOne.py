...
def main(answer):
    ...
    # guess = create_guess(full_word_database) will return start manuel switch to stare
    guess = "stare"
    # print(guess)
    ...
    while guessed_it != "y":
        ...
        result_of_guess = automated_get_result(guess, answer)

        if result_of_guess == "ggggg":
            guessed_it = "y"
        else:
            guess_number += 1
        ...
        # print("\n"+guess)
        # words_removed = words_removed - len(filtered_database)
        # print(words_removed)
...
def automated_get_result(guess, answer):
    result_of_guess = ""
    yellow_match = False
